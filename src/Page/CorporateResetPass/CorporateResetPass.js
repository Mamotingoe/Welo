            ...
            <div className="grid grid-cols-12 gap-x-6 fontNew">
                ...
                <div className='2xl:col-span-8 xl:col-span-6 lg:col-span-6 col-span-12 mx-3'>
                    <div className='flex sm:justify-end justify-center sm:mx-32 mx-0 mt-20 cursor-pointer'>
                        <p onClick={() => { navigate("/login") }}>Go back to <span className='text-[#EA5F5F] font-medium'>Main Screen</span></p>
                    </div>
                    <div className='text-start flex justify-center items-center h-[80vh]'>
                        <div>
                            <p className='fontNew sm:text-3xl text-lg font-semibold py-3'>Reset Password</p>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div>
                                    <button type='submit' className='mt-10 py-4 w-full rounded-2xl flex justify-center text-white text-base bg-[#EA5F5F]'>
                                        {
                                            isLoading ?
                                                <ThreeCircles
                                                    width={23}
...
export default CorporateResetPass